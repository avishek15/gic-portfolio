  ...
  return (
    <section className='text-white'>
        <div className='md:grid md:grid-cols-2 gap-4 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
            <Image src="/images/futuristic_3D_ARVR.jpg" 
             width={500}
             height={500}
             alt='3D_ARVR'
             className='rounded-3xl'/>
            <div className='mt-2 md:mt-0 flex flex-col h-full text-justify'>
              <h2 className='text-4xl font-bold text-white-100 mb-4 mt-4'>About Us</h2>
              <p className='text-base md:text-lg'>Guardian Info Consultants is a dynamic and innovative software 
                development company committed to providing cutting-edge solutions 
                tailored to meet the unique needs of its clients.</p>
                <div className='flex flex-row mt-8'>
                  <AboutTabButton selectTab={() => handleTabChange("Comprehensive IT Solutions")} active={(tab === "Comprehensive IT Solutions")}>Comprehensive IT Solutions</AboutTabButton>
                  <AboutTabButton selectTab={() => handleTabChange("Complete Cloud Product Suite")} active={(tab === "Complete Cloud Product Suite")}>Complete Cloud Product Suite</AboutTabButton>
                  <AboutTabButton selectTab={() => handleTabChange("AI Consultation and Deployment")} active={(tab === "AI Consultation and Deployment")}>AI Consultation and Deployment</AboutTabButton>
